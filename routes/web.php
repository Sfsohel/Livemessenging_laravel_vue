...
Route::get( 'deletesinglemessage/{id}', 'MessageController@deleteSingleMessage')->name('user.delete.singlemessage');
Route::get('deleteallmessage/{id}', 'MessageController@deleteAllMessage')->name('user.delete.Allmessage');
